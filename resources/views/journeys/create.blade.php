<x-app-layout title="Jornadas">
    <div class="container grid px-6 mx-auto">
        ...
        <form method="POST" action="/jornadas" autocomplete="off">
            {{ csrf_field() }}
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <label class="block text-sm mb-4">
                    ...
                    <input value="" name="max_points" required type="number" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Máximo Pontos" autocomplete="off" />
                </label>
