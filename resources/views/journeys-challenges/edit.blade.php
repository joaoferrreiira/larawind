            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <label class="block mb-4 text-sm">
                    ...
                    <select name="journeys_id" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:focus:shadow-outline-gray">
                        ...
                        <option @if($j->id == $challenge->id) selected @endif value="{{$j->id}}">{{$j->name}}</option>
                        @endforeach
                ...
                <label class="block text-sm mb-4">
                    ...
                    <input value="{{challenge->points}}" name="points" required type="number" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Pontos" autocomplete="off" />
                </label>
